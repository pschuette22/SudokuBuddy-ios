...
class Board {
    ...
    init(values: [[Int]]) {
        ...
        for y in 0..<9 {
            ...
            let row = Row(board: self, index: y, cells: rowCels)
            rows.append(row)
            groups.append(row)
        }
        ...
        for x in 0..<9 {
            ...
            let column = Column(board: self, index: x, cells: columnCells)
        ...
        for x1 in 0..<3 {
            ...
            for y1 in 0..<3 {
                ...
                let square = Square(board: self, sqCells: sqCells)
                sqRow.append(square)
    ...
    func solve() {
        ...
        while !isSolved {
            ...
            if solvedCells < 81 {
                ...
                // TODO: Implement swordfish strategy
    ...
    func printPossibilities(){
        for x in 0..<9 {
            for y in 0..<9 {
                let cell = cells[x][y]
                if !cell.isSolved {
                    debugPrint("\(x),\(y): \(cell.possibleValues)")
                }
            }
        }
    }
